 ...
 * @LastEditTime: 2022-04-07 11:20:36
 * @LastEditors: seven
 * @Description: 
 * @FilePath: \my-project\src\mine\report\web.vue
 * 博虹出品，抄袭必究😄
-->
<template>
...
export default {
    ...
    onLoad(options){
        ...
        let uri = `https://bjsyy.yuanbichang.top:9448/Visit/GetByIDCard?hospId=${hospId}&id=${str}&t=${timescamp}&co=${md5str}`;
        // console.log(uri)
        this.src = uri
    }
}
