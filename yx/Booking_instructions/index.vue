<template>
	<view class="page">
		...
		<view v-else class="notice-title">
			...
			<view><text class="title-txt">第四条</text> 同一天同一个科室每人只能挂号一次</view>
			<view><text class="title-txt">第五条</text> 同一天同一个医生每人只能挂号一次</view>
			<view><text class="title-txt">第六条</text> 同一天同一时间段每人只能挂号一次</view>
		</view>
